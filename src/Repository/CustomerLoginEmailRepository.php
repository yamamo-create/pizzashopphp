...
class CustomerLoginEmailRepository
{
    ...
    public function insert(string $email, bool $success, int $fail_count): void
    {
        try {
            ...
            $sql = "INSERT INTO customer_login_fail_emails(
                email,
                ip,
                created_at,
                success,
    ...
    public function findOne(string $email): false|array
    {
        try {
            ...
            $sql = "SELECT 
                ...
                success,
                fail_count 
            FROM customer_login_fail_emails 
            WHERE email=:email
            ORDER BY created_at DESC 
            LIMIT 1
            ";
    ...
    public function deleteAll(): void
    {
        try {
            ...
            $sql = 'DELETE FROM customer_login_fail_emails';
            $stmt = $dbh->prepare($sql);
            $stmt->execute();
        } catch (PDOException $e) {
            throw new RuntimeException('Database issue', 0, $e);
