...
$customer_change_email_onetime = CustomerOneTimeToken::generate('customer_change_email_onetime');
?>
                ...
                <section class="bgcolor">
                    <article>
                        <form method="post" action="check_done.php">
                            <p>現在のメールアドレス：<?php echo h($login_email); ?></p>
                            <p>変更したいメールアドレスを入力して下さい</p>
                            ...
                            <input type="hidden" name="customer_change_email_onetime" value="<?php echo h($customer_change_email_onetime); ?>">
                            <p>
