...
try {
    $adminEmailAllData = $adminManageSystem->getAdminEmailAllData();
    $displayData = $adminManageSystem->convertDisplayAdminEmailAllData($adminEmailAllData);
} catch (Throwable $e) {
    RedirectPage::adminErrPage($e);
}

$admin_csrf_token = AdminCsrf::ensure();
$system_admin_email_one_token = AdminOneTimeToken::generate('system_admin_email_one_token');
?>
<!DOCTYPE html>
<html lang="ja">
    ...
    <div class="body-wrapper">
        ...
        <main>
            <div class="main-wrapper">
                <section>
                    <h2>ログイン履歴（管理者ログインのメールアドレス履歴）</h2>
                </section>
                ...
                <section>
                    <form method="post" action="check_done.php">
                        ...
                        <input type="hidden" name="system_admin_email_one_token" value="<?php echo h($system_admin_email_one_token); ?>">
