...
try {
    $customerIpAllData = $adminManageSystem->getCustomerIpAllData();
    $displayData = $adminManageSystem->convertDisplayCustomerIpAllData($customerIpAllData);
} catch (Throwable $e) {
    RedirectPage::adminErrPage($e);
}

$admin_csrf_token = AdminCsrf::ensure();
$system_customer_ip_one_token = AdminOneTimeToken::generate('system_customer_ip_one_token');
?>
<!DOCTYPE html>
<html lang="ja">
            ...
            <div class="main-wrapper">
                ...
                <section>
                    <form method="post" action="check_done.php">
                        ...
                        <input type="hidden" name="system_customer_ip_one_token" value="<?php echo h($system_customer_ip_one_token); ?>">
